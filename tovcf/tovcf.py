...
def header():
    ...
    meta =\
        ["fileformat=VCFv4.1",
         ...
         """FORMAT=<ID=QS,Number=1,Type=Integer,Desctiption="Q Score">""",
         ...
         """FORMAT=<ID=DB,Number=1,Type=String,Description="dbSNP Membership">""",
         """FORMAT=<ID=OAS,Number=1,Type=String,Description="1000Genome Allele Counts">""",
         """FORMAT=<ID=EAS,Number=1,Type=String,Desctiption="ESP Allele Counts">"""
        ]
...
if __name__ == '__main__':
    ...
    # constants
    FORMAT = "GT:COV:QS:TS:CM:PM:DB:OAS:EAS"
    # fields from the csv
